 ...
 * <p>
 * Created by 璐从今夜白。 on 2020/7/9 19:01
 * <p>
 * Remark: 订单成交明细:/exchange/orders/{id}/details
 */
public class LB2014_BibiOrderIdDetailsTest extends PathData {
    @Autowired
    JsonUtil jsonUtil;
    @Autowired
    ...
    @Test(description = "订单成交明细", priority = 0, groups = {ServiceGroup.LB, ProjectGroup.LB})
    public void orderIdDetailsTest() throws IOException {
        Reporter.log("用例1：订单成交明细", true);
        //获取请求路径和url
