 ...
 * <p>
 * Created by 璐从今夜白。 on 2020/7/9 14:50
 * <p>
 * Remark: 全量聚合数据：/exchange/data/tick
 */
public class LB2004_BibiDataTickTest extends PathData {
    @Autowired
    JsonUtil jsonUtil;
    @Autowired
    ...
    @Test(description = "全量聚合数据", priority = 0, groups = {ServiceGroup.LB, ProjectGroup.LB})
    public void dataDepthTest() throws IOException {
        Reporter.log("用例1：全量聚合数据", true);
        //获取请求路径和url
