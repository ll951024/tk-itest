 ...
 * <p>
 * Created by 璐从今夜白。 on 2020/7/9 19:13
 * <p>
 * Remark: 根据用户获取30日交易量:/exchange/exchange/orders/btc/statistics
 */
public class Lb2017_BIbiStatisticsTest extends PathData {
    @Autowired
    JsonUtil jsonUtil;
    @Autowired
    ...
    @Test(description = "根据用户获取30日交易量", priority = 0, groups = {ServiceGroup.LB, ProjectGroup.LB})
    public void statisticsTest() throws IOException {
        Reporter.log("用例1：根据用户获取30日交易量", true);
        //获取请求路径和url
