 ...
 * <p>
 * Created by 璐从今夜白。 on 2020/7/7 16:19
 * <p>
 * Remark: 获取用户邀请码
 */
public class LB4001_InviteInfoTest extends PathData {
    @Autowired
    JsonUtil jsonUtil;
    @Autowired
    ...
    @Test(description = "查询用户邀请码", priority = 0, groups = {ServiceGroup.LB, ProjectGroup.LB})
    public void sevenDaycountTest() throws IOException {
        Reporter.log("用例1：查询用户邀请码", true);
        //获取请求路径和url
