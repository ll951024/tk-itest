 ...
 * <p>
 * Created by 璐从今夜白。 on 2020/7/7 18:47
 * <p>
 * Remark: 返佣记录
 */
public class LB4004_RebateRecordTest extends PathData {
    @Autowired
    JsonUtil jsonUtil;
    @Autowired
    ...
    @Test(description = "获取用户返佣记录", priority = 0, groups = {ServiceGroup.LB, ProjectGroup.LB})
    public void rebateRecordTest() throws IOException {
        Reporter.log("用例1：返佣记录", true);
        //获取请求路径和url
