 ...
 * <p>
 * Created by 璐从今夜白。 on 2020/7/9 19:05
 * <p>
 * Remark: 全局消息:/exchange/exchange/orders/message
 */
public class LB2015_BibiOrderMessage extends PathData {
    @Autowired
    JsonUtil jsonUtil;
    @Autowired
    ...
    @Test(description = "全局消息", priority = 0, groups = {ServiceGroup.LB, ProjectGroup.LB})
    public void orderMessageTest() throws IOException {
        Reporter.log("用例1：全局消息", true);
        //获取请求路径和url
