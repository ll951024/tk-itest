 ...
 * <p>
 * Created by 璐从今夜白。 on 2020/7/9 19:07
 * <p>
 * Remark: 币币交易-根据交易对查询:/exchange/currency/manage/get_by_symbol
 */
public class LB2016_BibiGetBySymbol extends PathData {
    @Autowired
    JsonUtil jsonUtil;
    @Autowired
    ...
    @Test(description = "币币交易-根据交易对查询", priority = 0, groups = {ServiceGroup.LB, ProjectGroup.LB})
    public void orderMessageTest() throws IOException {
        Reporter.log("用例1：币币交易-根据交易对查询", true);
        //获取请求路径和url
