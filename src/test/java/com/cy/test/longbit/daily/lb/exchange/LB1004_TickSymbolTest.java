 ...
 * <p>
 * Created by 璐从今夜白。 on 2020/7/8 17:55
 * <p>
 * Remark: 单个交易对行情:/exchange/tick/tick/{symbol}
 */
public class LB1004_TickSymbolTest extends PathData {
    @Autowired
    JsonUtil jsonUtil;
    @Autowired
    ...
    private String path = ex1004;
    private String host = devHost;
    private String val = "BTC-USDT";
...
/*    //获取登录接口返回值的auth
    ...
    @Test(description = "单个交易对行情", priority = 0, groups = {ServiceGroup.LB, ProjectGroup.LB})
    public void tickSymbolTest() throws IOException {
        Reporter.log("用例1：单个交易对行情", true);
        //获取请求路径和url
