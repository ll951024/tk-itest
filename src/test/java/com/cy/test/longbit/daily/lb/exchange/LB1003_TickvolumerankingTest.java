 ...
 * <p>
 * Created by 璐从今夜白。 on 2020/7/8 17:42
 * <p>
 * Remark: 首页成交额榜:/exchange/tick/tick_volume_ranking
 */
public class LB1003_TickvolumerankingTest extends PathData {
    @Autowired
    JsonUtil jsonUtil;
    @Autowired
    ...
    @Test(description = "首页成交额榜", priority = 0, groups = {ServiceGroup.LB, ProjectGroup.LB})
    public void tickDiffLimitTest() throws IOException {
        Reporter.log("用例1：首页成交额榜", true);
        //获取请求路径和url
