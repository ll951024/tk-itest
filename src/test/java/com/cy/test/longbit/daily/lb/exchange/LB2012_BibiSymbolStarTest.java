 ...
 * <p>
 * Created by 璐从今夜白。 on 2020/7/9 18:26
 * <p>
 * Remark: 用户自选：/exchange/data/symbols/star
 */
public class LB2012_BibiSymbolStarTest extends PathData {
    @Autowired
    JsonUtil jsonUtil;
    @Autowired
    ...
    @Test(description = "用户自选", priority = 0, groups = {ServiceGroup.LB, ProjectGroup.LB})
    public void symbolLimitTest() throws IOException {
        Reporter.log("用例1：用户自选", true);
        //获取请求路径和url
