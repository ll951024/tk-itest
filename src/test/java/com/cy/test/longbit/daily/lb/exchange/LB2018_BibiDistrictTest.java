 ...
 * <p>
 * Created by 璐从今夜白。 on 2020/7/9 19:19
 * <p>
 * Remark: 查询交易区:/exchange/exchange/data/district
 */
public class LB2018_BibiDistrictTest extends PathData {
    @Autowired
    JsonUtil jsonUtil;
    @Autowired
    ...
    @Test(description = "查询交易区", priority = 0, groups = {ServiceGroup.LB, ProjectGroup.LB})
    public void statisticsTest() throws IOException {
        Reporter.log("用例1：查询交易区", true);
        //获取请求路径和url
