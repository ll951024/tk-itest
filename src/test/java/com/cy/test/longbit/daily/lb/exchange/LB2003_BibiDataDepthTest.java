 ...
 * <p>
 * Created by 璐从今夜白。 on 2020/7/9 14:46
 * <p>
 * Remark: 全量深度:/exchange/data/depth
 */
public class LB2003_BibiDataDepthTest extends PathData {
    @Autowired
    JsonUtil jsonUtil;
    @Autowired
    ...
    @Test(description = "全量深度", priority = 0, groups = {ServiceGroup.LB, ProjectGroup.LB})
    public void dataDepthTest() throws IOException {
        Reporter.log("用例1：全量深度", true);
        //获取请求路径和url
        ...
        getAPI.getUrlParams().put("level","0");
