 ...
 * <p>
 * Created by 璐从今夜白。 on 2020/7/8 17:35
 * <p>
 * Remark: 首页涨幅榜:/exchange/tick/tick_diff_ranking
 */
public class LB1002_TickdiffrankingTest extends PathData {
    @Autowired
    JsonUtil jsonUtil;
    @Autowired
    ...
    @Test(description = "首页涨幅榜", priority = 0, groups = {ServiceGroup.LB, ProjectGroup.LB})
    public void tickDiffRankingTest() throws IOException {
        Reporter.log("用例1：首页涨幅榜", true);
        //获取请求路径和url
