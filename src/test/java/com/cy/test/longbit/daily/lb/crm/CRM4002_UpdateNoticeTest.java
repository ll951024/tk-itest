 ...
 * <p>
 * Created by 璐从今夜白。 on 2020/7/30 10:59
 * <p>
 * Remark: 修改公告： /longbit/crm/notice/update
 */
public class CRM4002_UpdateNoticeTest extends PathData {
    @Autowired
    JsonUtil jsonUtil;
    ...
    @Test(description = "更新公告成功", priority = 0, groups = {ServiceGroup.LB, ProjectGroup.LB})
    public void updateNoticeSuccessTest() throws IOException {
        //获取存在的公告ID
        List<Map<String, Object>> list1 = dbunitUtil.queryData(lbDataSource, "SELECT id from longbit.sys_notice where title =\"测试公告\";");
        if (CollectionUtils.isNotEmpty(list1)) {
            ...
            String requestBody = "{\"type\":1,\"title\":\"测试公告\",\"status\":1,\"lang\":\"zh-CN,en-US,ko-KR\",\"device\":\"APP\",\"langResource\":{\"en-US\":{\"pageTitle\":\"理财\",\"content\":\"理财\"},\"ko-KR\":{\"pageTitle\":\"理财\",\"content\":\"理财\"},\"zh-CN\":{\"pageTitle\":\"理财\",\"content\":\"理财\"}},\"deviceResource\":{\"APP\":{\"linkType\":\"2\",\"linkAddr\":\"/finances/index\"}},\"id\":"+val1+"}";
            // 设置请求uri和路径参数
            postAPI.setUrl(url);
