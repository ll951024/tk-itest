 ...
 * <p>
 * Created by 璐从今夜白。 on 2020/7/9 14:58
 * <p>
 * Remark: 添加自选:/exchange/data/symbols/star/add
 */
public class LB2005_BibiStarAddTest extends PathData {
    @Autowired
    JsonUtil jsonUtil;
    @Autowired
    ...
    @Test(description = "添加自选", priority = 0, groups = {ServiceGroup.LB, ProjectGroup.LB})
    public void starAddTest() throws IOException {
        Reporter.log("用例1：添加自选成功", true);
        //获取请求路径和url
