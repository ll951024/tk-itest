 ...
 * <p>
 * Created by 璐从今夜白。 on 2020/7/29 10:45
 * <p>
 * Remark: 交易区排序：/longbit/crm/exchange/district/update_sort
 */
public class CRM2004_UpdateSortTest extends PathData {
    @Autowired
    JsonUtil jsonUtil;
    ...
    public void updateSortSuccessTest() throws IOException {
        // 创建Post请求
        ...
        String requestBody = "{ \"idList\":[1,2,3,4,7] }";
        // 设置请求uri和路径参数
        postAPI.setUrl(url);
