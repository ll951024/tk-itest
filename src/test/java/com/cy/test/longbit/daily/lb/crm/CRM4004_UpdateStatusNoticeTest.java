 ...
 * <p>
 * Created by 璐从今夜白。 on 2020/7/30 11:01
 * <p>
 * Remark: 快速上下线:  /longbit/crm/notice/update_status
 */
public class CRM4004_UpdateStatusNoticeTest extends PathData {
    ...
    public void updateNoticeSuccessTest() throws IOException {
        ...
        if (CollectionUtils.isNotEmpty(list1)) {
            ...
            String requestBody = "{\"type\":1,\"status\":1,\"id\":"+val1+"}";
