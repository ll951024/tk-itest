 ...
 * <p>
 * Created by 璐从今夜白。 on 2020/7/9 18:12
 * <p>
 * Remark: 查询交易限额：/exchange/base/symbols/{symbol}/limit
 */
public class LB2011_BibiLimitTest extends PathData {
    @Autowired
    JsonUtil jsonUtil;
    @Autowired
    ...
    @Test(description = "查询交易限额", priority = 0, groups = {ServiceGroup.LB, ProjectGroup.LB})
    public void symbolLimitTest() throws IOException {
        Reporter.log("用例1：查询交易限额", true);
        //获取请求路径和url
